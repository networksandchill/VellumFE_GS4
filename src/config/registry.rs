...
static REGISTRY: LazyLock<Vec<SettingDef>> = LazyLock::new(|| {
    let mut defs = vec![
        ...
        enum_entry!("ui.menu_border_style", "Menu Border Style", "UI",
            "Popup/context menu border corners",
            &["rounded", "square"], ui.menu_border_style),
        // ---- Appearance ---------------------------------------------
        ...
        enum_entry!("target_list.truncation_mode", "Truncation Mode", "Targets",
            ...
            &["full", "noun", "noun_always"], target_list.truncation_mode),
        bool_entry!("target_list.show_dead", "Show Dead Creatures", "Targets",
            "Keep dead/gone creatures in the target list with their status",
            target_list.show_dead),
